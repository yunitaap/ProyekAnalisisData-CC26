...
# Load data
# ============================================================
df_day  = pd.read_csv('D:\College\Dicoding\SubmissionAnalisisData-CC26\dashboard\data_day.csv')
df_hour = pd.read_csv('D:\College\Dicoding\SubmissionAnalisisData-CC26\dashboard\data_hour.csv')
